                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" id="empleado_id" value="<?= $data['expedientes']['empleado_id']; ?>">
                            <table id="tableExpedientes" class="table table-striped table-bordered" style="width:100%">
            ...
            <form id="editForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        ...
                        <input type="file" class="form-control" id="edit_ubicacion" name="ubicacion" required>
                    </div>
                </div>
