        ...
        <div class="container-fluid px-4">
                    ...
                    <div class="modal-content">
                        <form id="createForm">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="createModalLabel">Añadir Documento Academico</h5>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editEmpresaModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="editForm">
                            <input type="hidden" id="edit_id_academica" name="id_academica">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="edit_nombre_documento" name="nombre_documento" required>
                                </div>
                                <div class="col-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="tableAcademico" class="table table-striped table-bordered" style="width:100%">
