            ...
            <div class="modal fade" id="createModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="createForm">
                            <input type="hidden" id="create_id_area" name="id_area">
                            <div class="modal-header">
                                <h5 class="modal-title" id="createModalLabel">Añadir Area</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="create_nombre" class="form-label">Nombre Area</label>
                                    <input type="text" class="form-control" id="create_nombre" name="nombre_area"
                                        required>
                                </div>
                                <div class="col-12">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="editForm">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="editEmpresaModalLabel">Editar Area</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="edit_nombre" class="form-label">Nombre Area</label>
                                    <input type="text" class="form-control" id="edit_nombre" name="nombre_area"
                                        required>
                                </div>
                                <div class="col-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="tableArea" class="table table-striped table-bordered" style="width:100%">
