    ...
    <main>
        ...
        <div class="container-fluid px-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4>Lista de Departamentos Laborales</h4>
            ...
            <div class="modal fade" id="createModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="createForm">
                            <input type="hidden" id="create_id_departamento" name="id_departamento">
                            <div class="modal-header">
                                <h5 class="modal-title" id="createModalLabel">Añadir Departamento Laboral</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="create_nombre" class="form-label">Nombre Departamento</label>
                                    <input type="text" class="form-control" id="create_nombre_departamento"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="editForm">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="editEmpresaModalLabel">Editar Departamento</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="edit_nombre_departamento" class="form-label">Nombre Departamento</label>
                                    <input type="text" class="form-control" id="edit_nombre_departamento"
                                        name="nombre_departamento" required>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label for="edit_area" class="form-label">Empleado</label>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="tableDepartamento" class="table table-striped table-bordered" style="width:100%">
