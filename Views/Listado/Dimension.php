    ...
    <main>
        ...
        <div class="container-fluid px-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4>Dimensiones para Lineas de Negocio</h4>
            ...
            <div class="modal fade" id="createModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="createForm">
                            <input type="hidden" id="create_id_empresa" name="id_dimension">
                            <div class="modal-header">
                                <h5 class="modal-title" id="createModalLabel">Añadir Dimension</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="create_nombre" class="form-label">Numero de Dimension</label>
                                    <input type="text" class="form-control" id="create_nombre" name="numero" required>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label for="create_nit" class="form-label">Naturaleza</label>
                                    <input type="text" class="form-control" id="create_nit" name="naturaleza" required>
                                </div>
                                <div class="col-12">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editEmpresaModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="editForm">
                            <input type="hidden" id="edit_id_dimension" name="id_dimension">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editEmpresaModalLabel">Editar Dimension</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="edit_numero" class="form-label">Numero Dimension</label>
                                ...
                                <div class="col-12">
                                    <label for="edit_naturaleza" class="form-label">Naturaleza</label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Lista de Dimensiones</h4>
                        </div>
                        <div class="card-body">
                            <table id="tableDimensiones" class="table table-striped table-bordered" style="width:100%">
