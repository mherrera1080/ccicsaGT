    ...
    <main>
        ...
        <div class="container-fluid px-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4>Lista de Puestos Laborales</h4>
            ...
            <div class="modal fade" id="createModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="createForm">
                            <input type="hidden" id="create_id_puesto" name="id_puesto">
                            <div class="modal-header">
                                <h5 class="modal-title" id="createModalLabel">Añadir Puesto</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="create_nombre" class="form-label">Nombre Puesto</label>
                                    <input type="text" class="form-control" id="create_nombre" name="nombre_puesto" required>
                                </div>
                                <div class="col-12">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editEmpresaModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="editForm">
                            <input type="hidden" id="edit_id_puesto" name="id_puesto">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editEmpresaModalLabel">Editar Puesto</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="edit_nombre" class="form-label">Nombre Puesto</label>
                                    <input type="text" class="form-control" id="edit_nombre" name="nombre_puesto" required>
                                </div>
                                <div class="col-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="tablePuestos" class="table table-striped table-bordered" style="width:100%">
