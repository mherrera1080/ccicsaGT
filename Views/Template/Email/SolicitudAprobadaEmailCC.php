...
try {
    ...
    // $mail->addCC($arrData['colaborador']['correo_jefe'], $arrData['colaborador']['nombre_jefe']); //C.C. para RH
    ...
    $mail->Body = "
        ...
        <body style='font-family: Arial, sans-serif; padding: 20px;'>
            <div style='max-width: 600px; padding: 20px; margin: auto; border-radius: 10px; box-shadow: 0px 0px 10px #ccc;'>
                ...
                <p>La solicitud de <strong>{$arrData['colaborador']['nombre_completo']}</strong>,</p>
                <p>ha sido aprobado con los siguientes detalles:</p>
