...
try {
    ...
    $mail->addAddress($arrData['solicitud']['correo_empresarial']); // Correo del solicitante

    $mail->addCC($arrData['jefes']['correo_aprobador_1'], $arrData['jefes']['nombre_aprobador_1']); //C.C. para RH
    $mail->addCC($arrData['jefes']['correo_aprobador_2'], $arrData['jefes']['nombre_aprobador_2']); //C.C. para RH
    $mail->addCC($arrData['jefes']['correo_aprobador_3'], $arrData['jefes']['nombre_aprobador_3']); //C.C. para RH

    // Contenido dinámico
    $mail->isHTML(true);
    $mail->Subject = "Confirmación de Solicitud de Vacaciones";
    ...
    $mail->Body = "
        ...
        <body style='font-family: Arial, sans-serif; padding: 20px;'>
            <div style='max-width: 600px; padding: 20px; margin: auto; border-radius: 10px; box-shadow: 0px 0px 10px #ccc;'>
                <h2 style='color: #333; text-align: center;'>Confirmación de Solicitud de Vacaciones</h2>
                ...
                <table style='width: 35%; border-collapse: collapse; margin-top: 10px;'>
                    ...
                    <tr>
                        ...
                        <td style='border: 1px solid #ddd; padding: 8px; color: green;'><strong>Aprobada</strong></td>
                    </tr>
                    <tr>
                        <td style='border: 1px solid #ddd; padding: 8px;'><strong>Aprobador 1:</strong></td>
                        <td style='border: 1px solid #ddd; padding: 8px;'>{$arrData['jefes']['nombre_aprobador_1']}</td>
                    </tr>
                    <tr>
                        <td style='border: 1px solid #ddd; padding: 8px;'><strong>Aprobador 2:</strong></td>
                        <td style='border: 1px solid #ddd; padding: 8px;'>{$arrData['jefes']['nombre_aprobador_2']}</td>
                    </tr>
                    <tr>
                        <td style='border: 1px solid #ddd; padding: 8px;'><strong>Aprobador 3:</strong></td>
                        <td style='border: 1px solid #ddd; padding: 8px;'>{$arrData['jefes']['nombre_aprobador_3']}</td>
                    </tr>
                </table>

                <h3 style='color: #333; text-align: left; margin-top: 20px;'>Detalles de las Fechas Aprobadas</h3>
                <table style='width: 75%; border-collapse: collapse; margin-top: 10px;'>
                    <tr>
                        <th style='border: 1px solid #ddd; padding: 8px; background: green; color: white;'>#</th>
                        <th style='border: 1px solid #ddd; padding: 8px; background: green; color: white;'>Fecha</th>
                        <th style='border: 1px solid #ddd; padding: 8px; background: green; color: white;'>Valor</th>
                        <th style='border: 1px solid #ddd; padding: 8px; background: green; color: white;'>Día</th>
                    </tr>
                    $detallesFechas
                </table>

                <h3 style='color: #333; text-align: left; margin-top: 20px;'>Comentario Aprobacion:</h3>
