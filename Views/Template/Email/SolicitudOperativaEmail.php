...
try {
    ...
    if ($arrData['estado'] == 'Pendiente Aprob. 2') {
        $revision = "<p>El usuario <strong>{$arrData['jefes']['nombre_aprobador_1']}</strong> ha aprobado tu solicitud con los siguientes detalles:</p>";
    } elseif ($arrData['estado'] == 'Pendiente Aprob. 3') {
        $revision = "<p>El usuario <strong>{$arrData['jefes']['nombre_aprobador_2']}</strong> ha aprobado tu solicitud con los siguientes detalles:</p>";
    } 
