...
try {
    ...
    if (!empty($arrData['solicitud']['revision_aprobador_1'])) {
        $mail->addCC($arrData['jefes']['correo_aprobador_1'], $arrData['jefes']['nombre_aprobador_1']);
    } 

    if (!empty($arrData['solicitud']['revision_aprobador_2'])) {
        $mail->addCC($arrData['jefes']['correo_aprobador_2'], $arrData['jefes']['nombre_aprobador_2']);
    } 

    if (!empty($arrData['solicitud']['revision_aprobador_3'])) {
        $mail->addCC($arrData['jefes']['correo_aprobador_3'], $arrData['jefes']['nombre_aprobador_3']);
    } 
