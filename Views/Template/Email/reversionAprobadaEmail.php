...
try {
    ...
    // Contenido dinámico
    $mail->isHTML(true);
    $mail->Subject = "Reversion de Dias Aprobada";
    $mail->Body = "
        <!DOCTYPE html>
        <html lang='es'>
        <head>
        ...
        <body style='font-family: Arial, sans-serif; padding: 20px;'>   
            <div style='max-width: 600px; padding: 20px; margin: auto; border-radius: 10px; box-shadow: 0px 0px 10px #ccc;'>
                <h2 style='color: #333; text-align: center;'>Solicitud de Reversion de Dias Aprobada</h2>
                <p>Estimado/a <strong>{$arrData['solicitud']['nombre_completo']}</strong>,</p>
                <p>Tu solicitud de reversion de vacaciones ha sido aprobada con los siguientes detalles:</p>
                ...
                <h3 style='color: #333; text-align: left; margin-top: 20px;'>Detalles de las Fechas Revertidas </h3>
