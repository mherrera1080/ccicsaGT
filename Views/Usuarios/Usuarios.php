    ...
    <main>
        ...
        <div class="container-fluid px-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <?php if ($_SESSION['permisosMod']['crear']) { ?>
                    ...
                    <div class="modal-content">
                        <form id="createForm">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="createModalLabel">Añadir Usuarios</h5>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="editForm">
                            ...
                            <input type="hidden" id="edit_id_colaborador" name="usuario_id">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editEmpresaModalLabel">Editar Usuario</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="edit_nombres" class="form-label">Usuario</label>
                                    <input type="text" class="form-control" id="edit_nombres" name="" disabled>
                                </div>
                                <div class="col-12">
                                    <label for="edit_correo_empresarial" class="form-label">Correo</label>
                                    <input type="text" class="form-control" id="edit_correo_empresarial" name=""
                                        disabled>
                                </div>
                                <div class="col-12">
